...
func builtins() []command {
	return []command{
		...
		{name: "config", help: "show operator settings (Discord app, signups, website)", run: runConfig},
		{name: "set", help: "set <key> [value] — change one setting; no value clears it", run: runSet},
		{name: "discord", help: "show / set / clear the Discord application sign-in uses", run: runDiscord},
		{name: "signups", help: "signups [list|open] — who may create an account", run: runSignups},
